...
onEvent('item.registry', event => {
	event.create('diamond_shard', item => {
	  ...
	  event.create('difficulty_changer', item => {
		...
		item.tooltip('§c使用时请勿在副手持有物品')
		item.tooltip('§a休闲')
		item.tooltip('§7- 正常的生存')
		item.tooltip('§7- 敌对生物掉落普通物品')
		item.tooltip('§e冒险')
		item.tooltip('§7- 怪物的攻击力增加10%')
		item.tooltip('§7- 生物受到的玩家伤害减少10%')
		item.tooltip('§7- 敌对生物有概率掉落稀有物品')
		item.tooltip('§c困难')
		item.tooltip('§7- 怪物的攻击力增加25%')
		item.tooltip('§7- 生物受到的玩家伤害减少20%')
		item.tooltip('§7- 敌对生物有概率掉落史诗物品')
		item.tooltip('§4末日')
		item.tooltip('§7- 怪物的攻击力增加50%')
		item.tooltip('§7- 生物受到的玩家伤害减少30%')
