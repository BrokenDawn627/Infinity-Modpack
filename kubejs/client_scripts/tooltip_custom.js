onEvent("item.tooltip", tooltip => {
    ...
    tooltip.addAdvanced('kubejs:shadow_katana', (item, advanced, text) => {

        if(!tooltip.isShift()) text.add(4, Text.translate('item.kubejs.shadow_katana.tooltip2'))
        else text.add(4, Text.translate('item.kubejs.shadow_katana.tooltip3'))
    })

    tooltip.addAdvanced('kubejs:digger', (item, advanced, text) => {

        if(!tooltip.isShift())
        {
            text.add(1, Text.translate('item.kubejs.digger.tooltip1'))
            text.add(2, Text.translate('item.kubejs.digger.tooltip3'))
        }
        else
        {
            text.add(1, Text.translate('item.kubejs.digger.tooltip2'))
            text.add(2, Text.translate('item.kubejs.digger.tooltip4'))
        }
    })
})